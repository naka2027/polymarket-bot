# V16 Historical Public Replay Report

[简体中文](./BACKTEST_V16.md) | **English**

[View current standardized replay](./BACKTEST_EN.md) · [Return to product documentation](./README_EN.md)

> This report preserves the code-replay snapshot for the historical V16 release. It documents the older version's methodology, behavior, and risk characteristics. It is not the current strategy report, a live account statement, or a return promise.

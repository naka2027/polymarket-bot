...
| 报告 | 用途 | 关键摘要 |
| --- | --- | --- |
| [最新策略标准回放](./BACKTEST.md) | 只比较信号方向质量和风险路径 | 146,846 笔，63.87%，标准 Score +109,880 |
| [动态仓位与风控回放](./BACKTEST_CAPITAL.md) | 在同一批最新信号上观察理想化资金路径 | 400 pUSD 初始资金，期末 21,273,734.6 pUSD；见报告口径和限制 |
| [V16 历史版本](./BACKTEST_V16.md) | 保留旧策略版本的可追溯结果 | 18,285 笔，63.75%，标准 Score +13,479 |
...
| 信号策略包 | `Stability Expansion` | 当前版本的最新策略选择 |
...
> 当前版本请选择界面中的 `Stability Expansion`。
